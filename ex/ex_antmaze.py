...
class Ex:
    def __init__(self, env, path, feature = lambda x : x[:2], frameskip = 1, resolution = 0.1, stochastic=True, budget= 200):
        ...
        self.Grid = Coverage_grid([70,70], [40,40], [[-30.01,40.01],[-30.01,40.01]])
        self.Grid.init_grid()
